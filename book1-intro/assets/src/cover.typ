...
#place(top + left, dx: 1.9cm, dy: 2.2cm)[
  #box(stroke: 1pt + green.transparentize(45%), radius: 999pt, inset: (x: 16pt, y: 7pt), fill: green.transparentize(93%))[
    #text(font: "DejaVu Sans Mono", size: 11pt, tracking: 1pt, fill: green)[OPENCODE 技術叢書 / 01]
  ]
]
...
#place(top + left, dx: 1.85cm, dy: 5.4cm)[
  ...
  #v(0.45cm)
  #text(weight: 900, stroke: 0.6pt + white, size: 82pt, tracking: 5pt, fill: white)[入門指南]
