...
| 冊序 | 書名 | 定位 | 難度 | 狀態 |
|------|------|------|------|------|
| 第一冊 | 《OpenCode 入門指南》 | 30分鐘快速上手 | 入門 | 大綱定稿 |
| 第二冊 | 《OpenCode 實戰寶典》 | 系統學習完整功能 | 中階 | 規劃中 |
| 第三冊 | 《OpenCode 架構解密》 | 內部設計深度解析 | 高階 | 規劃中 |
| 第四冊 | 《OpenCode 擴展開發》 | 打造專屬工具鏈 | 進階 | 規劃中 |
| 第五冊 | 《The OpenCode Stack》 | 省錢出活週末實戰 | 中階 | 規劃中 |
